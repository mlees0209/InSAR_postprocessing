...
# This script takes a Drummer-produced Single Look Complex (SLC), in combination with a dem .rsc file, and produces:
#		1. a basic image (png) map showing the SLC.
#		2. a .kml which projects the png map for viewing in Google Earth.
#		3. a .nc gridded version of the SLC (this is really a byproduct).
#
