...
# This script takes Drummer directory containing interferograms, averages the correlation for all of those interferograms and plots.
#
...
directory=$1
python /Users/mlees/Documents/RESEARCH/InSAR_processing/postprocessing_scripts/python_subroutines/create_mean_coherence.py $directory
